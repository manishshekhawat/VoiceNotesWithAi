      ...
      <div className="w-[40%] min-h-[75%] border border-gray-200 rounded-2xl shadow-2xl bg-white p-6 flex flex-col gap-6">
        ...
        {listening ? (
          <button
            ...
            className="w-full py-3 bg-red-500 text-xl font-semibold text-white rounded-xl"
          >
            Stop Recording
          </button>
        ) : (
          <button
            ...
            className="w-full py-3 bg-green-500 text-xl font-semibold text-white rounded-xl"
          >
            Start Recording
          </button>
        )}
